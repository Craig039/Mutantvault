...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="trust-strip"><div className="shell trust-grid"><div><span className="trust-icon">◇</span><strong>Curated</strong><span>Selected for eye appeal and long-term value</span></div><div><span className="trust-icon">◎</span><strong>Authentic</strong><span>Certified books and clear, honest details</span></div><div><span className="trust-icon">▣</span><strong>Secure</strong><span>Boxed, tracked, and insured shipping</span></div></div></section>
